%
% plot Y (latitude) cross sections of true checkerboard (vp and vs).
% Hao Guo.
%
clc
clear
...
for j=2:ny-1
    ...
    print(h,'-dpng',strcat('inter',num2str(pinter),'_truevp&vs_lat',num2str(Y(j)),'_lon',num2str(min_X),'-',num2str(max_X),'_Z',num2str(min_Z),'-',num2str(max_Z)),'-r300');
end
