%
% plot Z (depth) cross sections of true checkerboard (vp and vs).
% Hao Guo.
%
clc
clear
...
for k=2:nz-1
    ...
    print(h,'-dpng',strcat('inter',num2str(pinter),'_truevp&vs_Z',num2str(Z(k)),'_lon',num2str(min_X),'-',num2str(max_X),'_lat',num2str(min_Y),'-',num2str(max_Y)),'-r300');
end
