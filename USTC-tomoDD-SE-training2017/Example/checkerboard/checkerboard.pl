...
my $tomoDD = "tomoDD-SE"; # tomoDD-SE
my $tomoDD_syn="tomoDD-SE_syn"; # tomoDD-SE_syn
my $anomaly_x=1;
my $anomaly_y=1;
my $anomaly_z=1;
my $tomoDD_inp="tomoDD-SE.inp"; # parameter files
my $tomoDD_syn_inp="tomoDD-SE_syn.inp";  # parameter files
my $anomaly=0.05; # the amplitude velocity anomaly
my $chk_vp=[];
my $chk_vs=[];
my $rec_vp=[];
my $rec_vs=[];
...
my $ini_vs=[];
my $recover=[];
my $vp_model="Vp_model.dat"; # inverted vp
my $vs_model="Vs_model.dat"; # inverted vs
my $iteration=1;
my @head;
my @xarray;
my @yarray;
